...
const file_helloworld_proto_rawDesc = "" +
	...
	"helloworld\"\x1d\n" +
	"\aMessage\x12\x12\n" +
	"\x04body\x18\x01 \x01(\tR\x04body2F\n" +
	"\fHelloService\x126\n" +
	"\bSayHello\x12\x13.helloworld.Message\x1a\x13.helloworld.Message\"\x00B%\n" +
	"\x10com.example.grpcZ\x11models/helloworldb\x06proto3"
